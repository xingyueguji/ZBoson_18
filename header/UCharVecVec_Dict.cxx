...
#define R__DICTIONARY_FILENAME UCharVecVec_Dict
...
namespace {
  void TriggerDictionaryInitialization_UCharVecVec_Dict_Impl() {
...
#line 1 "UCharVecVec_Dict dictionary forward declarations' payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("UCharVecVec_Dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_UCharVecVec_Dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_UCharVecVec_Dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_UCharVecVec_Dict() {
  TriggerDictionaryInitialization_UCharVecVec_Dict_Impl();
}
