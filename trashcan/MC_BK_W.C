...
void MC_BK_W(){
	...
	file->cd();
	mc_reco_Zmass->Write("mc_W_bk",2);
	mc_reco_Zmass_0_24->Write("mc_W_bk_24",2);
	mc_reco_Zmass_24_100->Write("mc_W_bk_100",2);
	nEvents->Write("W_weight_factor",2);
	file->Close();
	obj1->f1->Close();
