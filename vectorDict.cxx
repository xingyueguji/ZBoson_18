...
namespace {
  void TriggerDictionaryInitialization_vectorDict_Impl() {
...
#line 1 "vectorDict dictionary forward declarations' payload"
...
#line 1 "vectorDict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("vectorDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_vectorDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_vectorDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_vectorDict() {
  TriggerDictionaryInitialization_vectorDict_Impl();
}
